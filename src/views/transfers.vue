  ...
  <ion-page>
      ...
      <ion-toolbar>
        <ion-title>
          ...
          <ion-button
            ...
            @click="newOrder()"
            ><ion-icon :icon="i.refreshCircleSharp"></ion-icon> Nuevo Traslado
          </ion-button>
        </ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content :fullscreen="true">
      ...
      <ion-list>
        ...
        <ion-button
          v-if="SelectDestination > 0"
          color="mycolor"
          class="btn-edit-product"
          expand="full"
          @click="getIdalmacenDestination()"
        >
          Aceptar</ion-button
        >
      </ion-list>
      <ion-content class="ion-padding">
        <ion-item>
          ...
          <ion-input
            type="text"
            :value="transfer.documento"
            @input="transfer.documento = $event.target.value"
          ></ion-input>
        </ion-item>
        <ion-item>
          ...
          <ion-input
            ...
            @input="transfer.detalle = $event.target.value"
          ></ion-input>
        </ion-item>
        ...
        <ion-button
          ...
          expand="full"
          @click="sendTransfer()"
          ><ion-icon :icon="i.saveSharp"></ion-icon>Enviar
        </ion-button>
        <ion-button
          color="mycolor"
          class="btn-edit-product"
        ...
        const product = [
          {
            ...
            precio: precio,
            idalmacendest: this.destination,
          },
        ];
    ...
    async sendTransfer() {
      try {
        ...
        if (this.finalNumber === 0) {
          ...
          this.transfer.idalmacen = this.origin;
          this.transfer.idalmdest = this.destination;
