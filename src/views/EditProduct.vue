<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-card>
        <ion-item>
          <ion-label position="floating">Agregar varios codigos de barras</ion-label>
          <ion-input type="text" :value="barcode.barcode" @input="barcode.barcode = $event.target.value">
          </ion-input>
          <ion-button color="dark" @click="addBarcodes(idProducto)"><ion-icon
              :icon="i.save"></ion-icon>Agregar</ion-button>
        </ion-item>
        <ion-item>
          <ion-label position="floating">Codigo de barras</ion-label>
          <ion-input type="text" :value="productEd.barcode" @input="productEd.barcode = $event.target.value"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label position="floating">Descripcion</ion-label>
          <ion-input type="text" :value="productEd.descripcion"
            @input="productEd.descripcion = $event.target.value"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label position="floating">costo</ion-label>
          <ion-input type="number" :value="productEd.costo" @input="productEd.costo = $event.target.value"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label position="floating">Precio Venta</ion-label>
          <ion-input type="number" :value="productEd.precioventa"
            @input="productEd.precioventa = $event.target.value"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label position="floating">Precio Especial 1</ion-label>
          <ion-input type="number" :value="productEd.precioespecial1"
            @input="productEd.precioespecial1 = $event.target.value"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label position="floating">Precio Especial 2</ion-label>
          <ion-input type="number" :value="productEd.precioespecial2"
            @input="productEd.precioespecial2 = $event.target.value"></ion-input>
        </ion-item>
        <ion-button color="dark" expand="full" @click="updateProduct(idProducto)"><ion-icon
            :icon="i.createSharp"></ion-icon>Editar</ion-button>
